...
export default withWinterSpec({
  ...
  const componentsWithExtendedPromotional = fullComponents.map((c) => ({
    ...c,
    is_extended_promotional: Boolean(c.preferred && !c.basic),
  }))

  const components = componentsWithExtendedPromotional.map((c) => ({
    lcsc: c.lcsc,
    mfr: c.mfr,
    package: c.package,
  ...
  return ctx.json({
    components: req.query.full ? componentsWithExtendedPromotional : components,
  })
})
