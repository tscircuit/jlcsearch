...
CREATE INDEX IF NOT EXISTS idx_component_catalog_extended ON component_catalog(extended);
...
CREATE INDEX IF NOT EXISTS idx_search_index_extended ON search_index(extended);
CREATE INDEX IF NOT EXISTS idx_search_index_extended_stock ON search_index(extended, stock DESC);
SEARCH_INDEX_SCHEMA
