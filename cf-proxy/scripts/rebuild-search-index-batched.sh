...
run_wrangler d1 execute "$DB_NAME" --remote --command \
  "CREATE INDEX IF NOT EXISTS idx_search_index_next_stock ON search_index_next(stock DESC);
   ...
   CREATE INDEX IF NOT EXISTS idx_search_index_next_extended_promo ON search_index_next(is_extended_promotional);"
...
run_wrangler d1 execute "$DB_NAME" --remote --command \
  "DROP TRIGGER IF EXISTS components_ai;
   ...
   DROP INDEX IF EXISTS idx_search_index_extended_promo;
   ...
   CREATE INDEX IF NOT EXISTS idx_search_index_extended_promo ON search_index(is_extended_promotional);"
