...
const COLUMN_LABELS: Record<string, string> = {
  ...
  voltage_rating: "Voltage (V)",
  current_rating: "Current (A)",
  ...
  current_rating_min: "Min Current (A)",
  memory_size_mbit: "Memory Size (Mbit)",
  clock_frequency_mhz: "Clock Frequency (MHz)",
  clock_frequency_min_mhz: "Min Clock Frequency (MHz)",
  voltage_rating_min: "Min Voltage (V)",
  reception_angle_deg: "Reception Angle (°)",
  luminous_intensity_mcd: "Luminous Intensity (mcd)",
  ...
  forward_current: "Forward Current (A)",
  forward_voltage: "Forward Voltage (V)",
  supply_voltage_min: "Min Supply Voltage (V)",
  supply_voltage_max: "Max Supply Voltage (V)",
  output_voltage_min: "Min Output Voltage (V)",
  output_voltage_max: "Max Output Voltage (V)",
  input_voltage_min: "Min Input Voltage (V)",
  input_voltage_max: "Max Input Voltage (V)",
  output_current_max: "Max Output Current (A)",
  operating_temp_min: "Min Temp",
  operating_temp_max: "Max Temp",
  pitch_mm: "Pitch (mm)",
  ddr_standard: "DDR Standard",
  height_above_board_mm: "Height Above Board (mm)",
  height_mm: "Height (mm)",
}
